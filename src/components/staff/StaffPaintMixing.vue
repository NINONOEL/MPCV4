    ...
    <div class="relative z-10 flex h-screen">
      ...
      <aside class="w-64 bg-gradient-to-b from-white to-gray-50 backdrop-blur-sm border-r border-gray-200 hidden md:flex md:flex-col shadow-lg">
        ...
        <nav class="flex-1 p-4 space-y-2 overflow-y-auto">
          ...
          <router-link 
            ...
            :class="{ 'hover:bg-pink-100 hover:text-pink-700': $route.path !== '/staff/paint-mixing' }"
          >
      ...
      <main class="flex-1 overflow-auto">
        ...
        <div class="p-6 md:p-8">
          ...
          <div v-else>
            <!-- Error Alert -->
            <div v-if="errorMessage" class="mb-6 p-4 bg-red-100 border border-red-200 rounded-lg text-red-800">
            ...
            <!-- Success Alert -->
            <div v-if="successMessage" class="mb-6 p-4 bg-green-100 border border-green-200 rounded-lg text-green-800">
              <div class="flex items-center">
                    ...
                    <div class="space-y-2">
                      ...
                      <div class="relative">
                        ...
                        >
                          ...
                          <option value="eggshell" class="bg-white text-gray-800">Eggshell</option>
                          <option value="satin" class="bg-white text-gray-800">Satin</option>
                          <option value="semi-gloss" class="bg-white text-gray-800">Semi-Gloss</option>
                      ...
                      <div class="flex-1">
                        ...
                        <div class="mt-2 flex items-center">
                          <span 
                            ...
                            :class="mix.createdBy === 'admin' ? 'bg-purple-100 text-purple-800' : 'bg-green-100 text-green-800'"
                          >
      ...
      <div v-if="showMixingTips" class="fixed z-50 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
        <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          ...
          <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
            <div class="px-6 pt-6 pb-6">
              <h3 class="text-xl font-bold text-gray-900 mb-6 flex items-center">
                <HelpCircleIcon class="w-6 h-6 mr-2 text-blue-600" />
          ...
          <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-md sm:w-full">
            <div class="px-6 pt-6 pb-6">
              ...
              <div class="flex justify-end gap-3">
                ...
                <button 
                  @click="confirmLogout"
                  class="px-4 py-2 bg-gradient-to-r from-orange-500 to-yellow-500 text-white rounded-lg hover:opacity-90 transition-colors shadow-lg flex items-center"
...
const createMixture = async () => {
  try {
    ...
    const validColors = mixture.colors.filter(color => color.name
    && color.ratio)
