      ...
      <div class="flex h-screen">
        ...
        <main class="flex-1 overflow-auto">
          <div class="p-4 md:p-6 lg:p-8">
            <!-- Header Section -->
            <div class="mb-8">
              <h1 class="text-2xl font-bold text-navy mb-2">Paint Mixing</h1>
              <p class="text-navy/60">Mix and create custom paint colors</p>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div class="space-y-6">
                ...
                <!-- Formula Details -->
                <div v-if="showResults" class="bg-white rounded-xl shadow-sm p-4 md:p-6">
