              ...
              <form @submit.prevent="generateRecommendations" class="space-y-6">
                ...
                <div class="space-y-2">
                  ...
                  <select 
                    ...
                    class="w-full bg-white/5 border border-white/10 rounded-lg text-white px-4 py-3 focus:ring-2 focus:ring-white/20 focus:border-transparent transition-all placeholder-white/40"
                  >
                    <option value="" disabled>Select surface material</option>
                ...
                <div class="space-y-2">
                  ...
                  <select 
                    ...
                    class="w-full bg-white/5 border border-white/10 rounded-lg text-white px-4 py-3 focus:ring-2 focus:ring-white/20 focus:border-transparent transition-all placeholder-white/40"
                  >
                    <option value="" disabled>Select color preference</option>
...
const generateRecommendations = () => {
  ...
  // Simulate API call
  setTimeout(() => {
    // Generate multiple color scheme recommendations
    allRecommendations.value = generateMultipleColorSchemes();
    loading.value = false;
  }, 1500);
};
...
const generateMultipleColorSchemes = () => {
  ...
  const baseSchemes = {
    ...
    traditional: [
      [
        { name: 'Bahay Kubo', hex: '#A68A64' },
        { name: 'Capiz Shell', hex: '#F5F5F0' },
        { name: 'Narra Wood', hex: '#B7521E' },
        { name: 'Banana Leaf', hex: '#4F7942' },
      ],
      [
        { name: 'Abaca', hex: '#C19A6B' },
        { name: 'Pearl White', hex: '#F8F8FF' },
        { name: 'Mahogany', hex: '#C04000' },
        { name: 'Bamboo', hex: '#7B7F32' },
      ],
      [
        { name: 'Rattan', hex: '#D7C29E' },
        { name: 'Ivory', hex: '#FFFFF0' },
        { name: 'Acacia', hex: '#966F33' },
        { name: 'Palm', hex: '#558367' },
      ],
      [
        { name: 'Coconut', hex: '#965A3E' },
        { name: 'Seashell', hex: '#FFF5EE' },
        { name: 'Kamagong', hex: '#800000' },
        { name: 'Mangrove', hex: '#3B5E2B' },
      ],
      [
        { name: 'Molave', hex: '#8B7355' },
        { name: 'Rice Paper', hex: '#F2F3F4' },
        { name: 'Yakal', hex: '#8B4513' },
        { name: 'Sampaguita', hex: '#F8F6F0' },
      ],
    ],
  };
